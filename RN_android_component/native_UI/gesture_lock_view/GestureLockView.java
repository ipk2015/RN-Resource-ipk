...
import com.cm_wealth_app.rn_native_android.R;
...
public class GestureLockView extends View {
    ...
    private Cell detectAndAddHit(float x, float y) {
        ...
        if (cell != null) {
            //  下面注释掉这段是为了当两个点连线中间有点时加上这个中间点，但有的项目反而不需要加上这个中间点，视项目需求而定吧
    ...
    private void sendAccessEvent(String eventName) {
        announceForAccessibility(eventName);
    }
    ...
    private static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link GestureLockView#onSaveInstanceState()}
         */
